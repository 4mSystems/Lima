...
import app.te.lima_zola.databinding.FragmentPrivacyBinding
...
@AndroidEntryPoint
class PrivacyFragment : BaseFragment<FragmentPrivacyBinding>(), BaseEventListener {
